...
public class TestSyncStorageRequest {
  ...
  public void testRetryAfterResponse() throws URISyntaxException {
    ...
    SyncStorageRecordRequest r = new SyncStorageRecordRequest(new URI(LOCAL_BAD_REQUEST_URL)); // actual URL is not used
  ...
  public void testWeaveBackoffResponse() throws URISyntaxException {
    ...
    SyncStorageRecordRequest r = new SyncStorageRecordRequest(new URI(LOCAL_META_URL)); // URL re-used -- we need any succesful response
